...
Imaginons que la différence entre le capteur de droite et celui de gauche est de -30% de luminosité par rapport à la luminosité maximale, le système devra effectuer une action de $k \times 0,3α$ ver avec $α$ en t